...
async function startServer() {
    try {
        ...
        // Schedule: Send reminders at 10:30 PM IST every day
        cron.schedule("30 22 * * *", async () => {
            console.log("[Cron] Running reminder job at 10:30 PM IST...");
            try {
                await checkAllUsers();
        ...
        console.log("[Cron] Scheduled: Reminders at 10:30 PM IST, Daily update at 5:00 AM IST");
